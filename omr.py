...
while(1):
    ...
    if biggest.size != 0:
            ...
            boxesCountoursList = [[210,45],[210,590],[1670,590],[1670,45]]
            ...
            boxesArea = boxesArea[45:590, 210:1670]
            boxesArea = cv2.resize(boxesArea,(imgHeight,imgWidth))

            # APPLY ADAPTIVE THRESHOLD
            boxesAreaGray = cv2.cvtColor(boxesArea, cv2.COLOR_BGR2GRAY)
            boxesAreaTresh = cv2.threshold(boxesAreaGray,90, 255, cv2.THRESH_BINARY_INV)[1]
